...
class Parameters::LocalizationParametersController < ApplicationController
  ...
  def update
    ...
    ActiveRecord::Base.transaction do
      default_language_param = Parameter.find_or_create_by(label: "app.localization.default_language",
                                                           value_type: "string")
      default_language_param.value = default_language
      default_language_param.save!

      available_languages_param = Parameter.find_or_create_by(label: "app.localization.available_languages",
                                                              value_type: "json")
