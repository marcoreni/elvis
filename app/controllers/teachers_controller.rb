...
class TeachersController < ApplicationController
  ...
  def list_activities
    ...
    activities = Activity
                 ...
                 .as_json(
                   include: %i[time_interval room activity_ref]
                 )
  ...
  def show_with_overlap
    ...
    render status: 400, json: { error: "unknown teacher" } and return unless @teacher
    ...
    if recurrence == 0
      ...
      # on sécurise le from et le to
      _, to_date = interval.check_and_adjust_range(from_date, to_date).values
