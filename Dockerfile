...
ARG LOG_PLUGINS_BACKTRACE_ERRORS
ENV LOG_PLUGINS_BACKTRACE_ERRORS=$LOG_PLUGINS_BACKTRACE_ERRORS
RUN export LOG_PLUGINS_BACKTRACE_ERRORS=$LOG_PLUGINS_BACKTRACE_ERRORS
