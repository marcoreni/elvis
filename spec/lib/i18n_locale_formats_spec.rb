...
RSpec.describe "I18n custom date/time formats" do
  # Regression test: config/locales/en.yml used to be a stub, so any I18n.l/I18n.localize call
  # with one of these custom format keys raised I18n::MissingTranslationData as soon as a user's
  # locale was :en (e.g. app/models/season.rb, app/views/students/index.html.erb).
