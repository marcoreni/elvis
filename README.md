...
## Removed dead code
See [`docs/OrphanedCode.md`](docs/OrphanedCode.md) for the log of code deleted from this app on
suspicion of being dead/unreachable, with recovery instructions.
