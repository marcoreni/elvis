class AddMessageMailerToNotificationTemplates < ActiveRecord::Migration[6.1]
  ...
  def down
    NotificationTemplate.find_by(path: "message_mailer/send_message")&.destroy
  end
