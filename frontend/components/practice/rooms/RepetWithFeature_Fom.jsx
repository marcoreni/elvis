    ...
    render() {
        ...
        return (
            <div>
                <div className="form-group">
                    ...
                    <div className="onoffswitch">
                        <input
                            ...
                            type="checkbox"
                            name="room[is_practice_room]"
                            id="is_practice_room"
                            value={!!this.state.isRepet}
                            checked={this.state.isRepet}
                            onChange={() => {
                ...
                {this.state.isRepet &&
                this.props.all_features !== undefined &&
                this.props.all_features.length > 0 ? (
                    <div className="form-group">
                        <SelectMultiple
