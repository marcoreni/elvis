    ...
    return (
        <Fragment>
            <div className="row wrapper border-bottom white-bg page-heading m-b-md">
                <h2>{t("parameters:errorHistory.title")}</h2>
            </div>
                            ...
                            >
                                <div className="ibox float-e-margins">
                                    ...
                                    <div className="ibox-content p-sm-0">
                                        ...
                                        {Object.keys(error.related_objects)
                                            .length > 0 && (
                                            <div
                                                    ...
                                                    <div className="panel-heading">
                                                        <h5 className="panel-title">
                                                            ...
                                                            >
                                                                <h4>
                                                                    {t(
                                                                        "parameters:errorHistory.relatedObjects"
                                                                    )}{" "}
                                                                ...
                                                                <table className="table table-striped">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>
                                                                                {t(
                                                                                    "parameters:errorHistory.variableName"
                                                                                )}
                                                                            </th>
                                                                            <th>
                                                                                {t(
                                                                                    "parameters:errorHistory.class"
                                                                                )}
                                                                            </th>
                                                                            <th>
                                                                                {t(
                                                                                    "parameters:errorHistory.id"
                                                                                )}
                                                                            </th>
                                                                        </tr>
                                                                    </thead>
                                                ...
                                                <div className="panel-heading">
                                                    <h5 className="panel-title">
                                                        ...
                                                        >
                                                            <h4>
                                                                {t(
                                                                    "parameters:errorHistory.stackTrace"
                                                                )}{" "}
                                                                <span className="caret"></span>
                                                            </h4>
                                                        </a>
