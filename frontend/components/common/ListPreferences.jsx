...
export default function ListPreferences({
    ...
    const mergePreferences = () => {
        ...
        const prefs = _.filter(preferences, ({ id }) =>
            _.find(columns, { id })
        );
    ...
    const changeOrder = e => {
        ...
        const constrainToSize = i =>
            Math.min(newValues.length - 1, Math.max(0, i));
    ...
    // RENDER HELPERS
    const createColumnEditor = ({ id, name, disabled, order }) => (
        <ColumnEditor
            key={id}
            index={order}
            name={name}
    ...
    return (
        <div className={className}>
            <button
                ...
                data-tippy-content={t("common:listPreferences.title")}
            >
            ...
            >
                ...
                <div>
                    ...
                    >
                        ...
                        {t("common:listPreferences.reset")}
                    </button>
                    <button
...
const ColumnEditor = ({
    ...
    <div className="column">
        ...
        <p style={{ margin: "auto 0" }}>
            <strong>{disabled ? <strike>{name}</strike> : name}</strong>
        </p>
