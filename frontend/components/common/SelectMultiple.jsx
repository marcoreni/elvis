...
export default class SelectMultiple extends React.Component {
        ...
        if (
            ...
            if (this.props.mutators && this.props.name) {
                this.state.selectedFeatures.forEach((f, i) =>
                    this.props.mutators.update(this.props.name, i, f.value)
                );
            }
        }
    }
    ...
    handleChange(values, actionMeta) {
        if (actionMeta.action === "select-option") {
            ...
            if (this.props.isMulti) _.remove(this.state.features, newFeature);
            ...
            if (this.props.mutators && this.props.name) {
                this.props.mutators.remove(
                    this.props.name,
                    this.state.selectedFeatures.indexOf(actionMeta.removedValue)
                );
            }
            ...
            const clear = () => {
                ...
                if (this.props.mutators && this.props.name) {
                    while (
                        this.props.mutators.pop(this.props.name) !== undefined
                    );
                }
            ...
            const confirm =
                this.props.confirmBeforeClear === undefined
                    ? true
