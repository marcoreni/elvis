            ...
            <React.Fragment>
                ...
                this.props.infos.possibleMatches.length > 0 ? (
                    <div className="alert alert-success col-md-12">
                        ...
                        {_.map(this.props.infos.possibleMatches, (m, i) => {
                            return (
                                <p
                                    key={i}
                                    onClick={() =>
                ...
                <ContactInfos
                    ...
                    handleDeletePhoneNumber={idx =>
                        this.props.handleDeleteFamilyMemberPhoneNumber(
                            idx,
                            this.props.idx
                        )
                    }
                    ...
                    <div className="row">
                        <div className="col-xs-12">
                            ...
                            <p>
                                ...
                                {" est "}
                                {this.props.infos.link ? (
                                    <strong>{this.props.infos.link}</strong>
                                ) : (
                                    "..."
                                )}
                                {" de "}
                            ...
                            <div className="col-md-3 col-sm-12">
                                <div className="checkbox checkbox-primary">
                                    <input
                                        ...
                                        checked={
                                            this.props.infos.is_accompanying ||
                                            false
                                        }
                                        onChange={e =>
                                            this.props.handleChangeMemberInfos(
                            ...
                            <div className="col-md-3 col-sm-12">
                                <div className="checkbox checkbox-primary">
                                    <input
                                        ...
                                        name="is_to_call"
                                        checked={
                                            this.props.infos.is_to_call || false
                                        }
                                        onChange={e =>
                                            this.props.handleChangeMemberInfos(
                                                e
