    ...
    return (
        <div className="row">
            <div className="col-sm-5">
                <div
                    className={`ibox animated fadeInRight border-${
                        isClicked ? "lightblue" : "transparent"
                    }`}
                    onClick={() => handleClick(activity)}
                    style={
                        activity.student_attendances.length >=
                        activity_ref.occupation_limit
                            ? {
                                  pointerEvents: "none",
                                  cursor: "not-allowed",
                              }
                                ...
                                <div className="col-sm-3 p-xs">
                                    <div className="delete-icon mt-5">
                                        <h4 className="pull-right">
                                            {t(
                                                "activityApplications:packs.card.full"
                                            )}
                                        </h4>
                                    </div>
                                </div>
