...
class ActivityRefKind extends BaseDataTable {
    constructor(props) {
        ...
        this.state.columns = [
            ...
            },
            {
                ...
                Header: this.props.t(
                    "activities:activityRefKind.columns.defaultActivity"
                ),
                accessor: (d) =>
                    d.default_activity_ref ? d.default_activity_ref.label : "",
            },
            {
                id: "actions",
    ...
    deleteStatus(status) {
        swal.fire({
            title: this.props.t("activities:activityRefKind.confirmDelete", {
                name: status.name,
            }),
            icon: "warning",
