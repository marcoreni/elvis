...
export default function MailSettings(props: {
    mail_settings: Form & { redirect: string[] };
}) {
            ...
            <div className="col-md-6 col-xs-12">
                <div>
                    ...
                    <p className="text-danger">
                        {errors.address &&
                            t("editParameters.mail.smtpAddressRequired")}
                    </p>
                </div>
                ...
                <div>
                    ...
                    />
                    <p className="text-danger">
                        {errors.port && t("editParameters.mail.portRequired")}
                    </p>
                </div>
                ...
                <div className="mt-2 mb-2">
                    <label>{t("editParameters.mail.sslTlsLabel")}</label>
                    <br />
                    <input
                        className="m-2"
                        type="checkbox"
                ...
                <div>
                    ...
                    <p className="text-danger">
                        {errors.authentication &&
                            t("editParameters.mail.authRequired")}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-danger">
                        {errors.user_name &&
                            t("editParameters.mail.usernameRequired")}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        type="password"
                        {...register("password", {
                            required: props.mail_settings.password == "",
                        })}
                    />
                    <p className="text-danger">
                        {errors.password &&
                            t("editParameters.mail.passwordRequired")}
                    </p>
                </div>
