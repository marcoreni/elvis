            ...
            <section className="m-t">
                <article>
                    <UserSearch
                        ...
                        onSelect={user => {
                            ...
                            this.setState({
                                ...
                                selected:
                                    min ||
                                    moment(this.props.season.end).format(
                                        "YYYY-MM-DD"
                                    ),
                            });
                        }}
                    ...
                    <section className="flex flex-end-justified m-b">
                        ...
                        >
                            {t("users:adhesion.chooseStudent")}
                        </button>
                    </section>
                </article>
                ...
                {user && userValidated && (
                    <section className="panel panel-default">
                        <div className="panel-heading">
                            <h3>
                                {t("users:adhesion.membershipFor", {
                            ...
                            <div className="panel-body">
                                <div className="row">
                                    <div className="col-sm-6 form-group">
                                        <label>
                                            {t(
                                                "users:adhesion.validityStartDate"
                                            )}
                                        </label>
                                        <input
                                            type="date"
...
export default withTranslation("users")(Adhesion);
