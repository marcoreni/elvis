...
class UsersTest < ActiveSupport::TestCase
  ...
  test "get_paying_family_members" do
    ...
    father_link = FamilyMemberUser.create!({ user: father, member: child, is_paying_for: true,
                                             season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: mother, member: child, is_paying_for: false,
                               season: Season.current_apps_season })
  ...
  test "father should pay for child" do
    ...
    FamilyMemberUser.create!({ user: child, member: father, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: child, member: mother, is_paying_for: false,
                               season: Season.current_apps_season })
  ...
  test "couple one payer" do
    ...
    FamilyMemberUser.create!({ user: woman, member: man, is_paying_for: true,
                               season: Season.current_apps_season })
  ...
  test "couple no payer" do
    ...
    woman = User.create!({ first_name: "Woman", birthday: "10/10/1991", email: "woman5@example.com",
                           is_paying: true })

    FamilyMemberUser.create!({ user: woman, member: man, is_paying_for: false,
                               season: Season.current_apps_season })
  ...
  test "couple both payer for both" do
    ...
    FamilyMemberUser.create!({ user: woman, member: man, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: man, member: woman, is_paying_for: true,
                               season: Season.current_apps_season })
  ...
  test "multiple payers simple" do
    ...
    mother = User.create!({ first_name: "mother", birthday: "10/10/1991", email: "mother7@example.com",
                            is_paying: true })

    FamilyMemberUser.create!({ user: child, member: father, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: child, member: mother, is_paying_for: true,
                               season: Season.current_apps_season })
  ...
  test "multiple payers complex" do
    ...
    FamilyMemberUser.create!({ user: first_child, member: father, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: first_child, member: mother, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: second_child, member: father, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: second_child, member: mother, is_paying_for: false,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: third_child, member: father, is_paying_for: false,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: third_child, member: mother, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: second_child, member: first_child, is_paying_for: false,
                               season: Season.current_apps_season })
  ...
  test "Multiple adult payers" do
    florence = User.create!({ first_name: "florence", birthday: "10/10/1990", email: "florence9@example.com",
                              is_paying: true })
    ...
    FamilyMemberUser.create!({ user: bernard, member: florence, is_paying_for: false,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: clara, member: bernard, is_paying_for: true,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: clara, member: florence, is_paying_for: false,
                               season: Season.current_apps_season })
    FamilyMemberUser.create!({ user: clara, member: julie, is_paying_for: false,
                               season: Season.current_apps_season })
